...
public:
  ...
  // OpCodes - Following https://rgbds.gbdev.io/docs/v0.9.1/gbz80.7#LD_r8,r8 but with more meaningful (for me, at least)
  // names Load/Store operations
  ...
  void rotate_value_at_hl_address_left_with_carry(void *args);     // RLC [HL]
