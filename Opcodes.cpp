...
static OpCode push_next_address_to_stack = OpCode(&Cpu::push_next_address_to_stack, 6, 3); 
static OpCode push_next_address_to_stack_conditionally = OpCode(&Cpu::push_next_address_to_stack_conditionally, 6, 3); 
...
static OpCode add_hl_to_sp = OpCode(&Cpu::add_hl_to_sp, 2, 1); 
